...
function SectionTopContent({title,description,stars = 0,children,className=""}:ContentType) {
  return (
    <div className={`flex flex-col gap-6 mb-8 items-center text-center ${className}`}>
