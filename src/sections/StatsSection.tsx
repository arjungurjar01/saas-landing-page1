...
function StatsSection({}) {
  return (
    <div className="min-h-screen px-4 md:px-16 lg:px-4 flex flex-col items-center ">
      <SectionTopContent
        title="The Mintly Advantage"
        description="Traditional content creation is slow and expensive. We fixed that."
      >
        {" "}
        <HiMiniTrophy />
      ...
      <div className="flex flex-col md:flex-row sm:gap-4 mt-8 px-4  md:gap-2 lg:gap-4">
        {statsData.map((item) => {
          return (
            <StatsCard
              icon={<item.icon />}
